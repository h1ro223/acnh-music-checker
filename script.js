...
function bindEvents() {
  ...
  const btnFooterAbout = document.getElementById('btnFooterAbout');
  ...
  btnFooterAbout.addEventListener('click', openAbout);
  ...
  const aboutJp = document.getElementById('aboutJp');
  ...
  langToggleBtn.addEventListener('click', () => {
    const isEnActive = langToggleBtn.classList.toggle('en-active');

    if (isEnActive) {
      aboutJp.classList.add('hidden');
      aboutEn.classList.remove('hidden');
      jpLabel.classList.remove('active');
      enLabel.classList.add('active');
    } else {
      aboutJp.classList.remove('hidden');
